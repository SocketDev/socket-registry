---
name: code-reviewer
description: Reviews code in socket-registry against CLAUDE.md rules and reports style violations, logic bugs, and test gaps. Spawned by the quality-scan skill or invoked directly on a diff.
