...
description: Reviews findings from AgentShield + zizmor against socket-registry's CLAUDE.md security rules and grades the result A-F. Spawned by the security-scan skill after the static scans run.
