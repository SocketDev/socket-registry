    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .claude/hooks/fleet/prefer-json-clone-guard/index.mts"
          }
        ]
      }
    ]
...
This hook lives in `socket-wheelhouse/template/.claude/hooks/prefer-json-clone-guard`
