    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .claude/hooks/fleet/soak-exclude-date-guard/index.mts"
          }
        ]
      }
    ]
...
This hook lives in `socket-wheelhouse/template/.claude/hooks/soak-exclude-date-guard`
