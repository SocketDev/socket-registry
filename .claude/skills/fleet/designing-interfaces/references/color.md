...
- [Context first](#0-context-first)
- [Color space and palette structure](#1-color-space)
- [Contrast and themes](#4-contrast-and-readability)
- [Building a palette](#7-building-a-palette-from-scratch)
- [Gradients, anti-patterns, and checklists](#8-gradients)
- [Complete token system](#appendix-complete-token-system)
