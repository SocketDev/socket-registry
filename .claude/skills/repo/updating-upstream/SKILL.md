...
description: Bumps non-lockstep `.gitmodules` submodules to their latest stable upstream tag, updating the `# <name>-<version>` pin comment. Invoked by the `updating` umbrella or standalone.
user-invocable: true
