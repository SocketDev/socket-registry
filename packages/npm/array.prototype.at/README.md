...
>A tested zero dependency drop-in replacement of [`array.prototype.at`](https://socket.dev/npm/package/array.prototype.at) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.at`
...
```sh
pnpm install @socketregistry/array.prototype.at
```
