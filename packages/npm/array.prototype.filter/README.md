...
>A tested zero dependency drop-in replacement of [`array.prototype.filter`](https://socket.dev/npm/package/array.prototype.filter) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.filter`
...
```sh
pnpm install @socketregistry/array.prototype.filter
```
