...
>A tested zero dependency drop-in replacement of [`array.prototype.find`](https://socket.dev/npm/package/array.prototype.find) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.find`
...
```sh
pnpm install @socketregistry/array.prototype.find
```
