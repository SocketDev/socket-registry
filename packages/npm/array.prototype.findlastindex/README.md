...
>A tested zero dependency drop-in replacement of [`array.prototype.findlastindex`](https://socket.dev/npm/package/array.prototype.findlastindex) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/array.prototype.findlastindex
```
