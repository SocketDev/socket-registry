...
>A tested zero dependency drop-in replacement of [`array.prototype.flat`](https://socket.dev/npm/package/array.prototype.flat) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.flat`
...
```sh
pnpm install @socketregistry/array.prototype.flat
```
