...
>A tested zero dependency drop-in replacement of [`array.prototype.flatmap`](https://socket.dev/npm/package/array.prototype.flatmap) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.flatmap`
...
```sh
pnpm install @socketregistry/array.prototype.flatmap
```
