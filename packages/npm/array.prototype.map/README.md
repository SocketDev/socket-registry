...
>A tested zero dependency drop-in replacement of [`array.prototype.map`](https://socket.dev/npm/package/array.prototype.map) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.map`
...
```sh
pnpm install @socketregistry/array.prototype.map
```
