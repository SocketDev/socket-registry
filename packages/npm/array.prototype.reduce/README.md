...
>A tested zero dependency drop-in replacement of [`array.prototype.reduce`](https://socket.dev/npm/package/array.prototype.reduce) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/array.prototype.reduce`
...
```sh
pnpm install @socketregistry/array.prototype.reduce
```
