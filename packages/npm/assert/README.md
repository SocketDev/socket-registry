...
>A tested zero dependency drop-in replacement of [`assert`](https://socket.dev/npm/package/assert) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/assert`
...
```sh
pnpm install @socketregistry/assert
```
