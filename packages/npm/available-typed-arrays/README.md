...
>A tested zero dependency drop-in replacement of [`available-typed-arrays`](https://socket.dev/npm/package/available-typed-arrays) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/available-typed-arrays`
...
```sh
pnpm install @socketregistry/available-typed-arrays
```
