...
>A tested zero dependency drop-in replacement of [`deep-equal`](https://socket.dev/npm/package/deep-equal) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/deep-equal`
...
```sh
pnpm install @socketregistry/deep-equal
```
