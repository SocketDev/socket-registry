...
>A tested zero dependency drop-in replacement of [`es-aggregate-error`](https://socket.dev/npm/package/es-aggregate-error) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/es-aggregate-error`
...
```sh
pnpm install @socketregistry/es-aggregate-error
```
