...
>A tested zero dependency drop-in replacement of [`es-get-iterator`](https://socket.dev/npm/package/es-get-iterator) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/es-get-iterator`
...
```sh
pnpm install @socketregistry/es-get-iterator
```
