...
>A tested zero dependency drop-in replacement of [`es-iterator-helpers`](https://socket.dev/npm/package/es-iterator-helpers) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/es-iterator-helpers`
...
```sh
pnpm install @socketregistry/es-iterator-helpers
```
