...
>A tested zero dependency drop-in replacement of [`es-set-tostringtag`](https://socket.dev/npm/package/es-set-tostringtag) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/es-set-tostringtag
```
