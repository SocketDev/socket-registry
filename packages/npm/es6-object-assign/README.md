...
>A tested zero dependency drop-in replacement of [`es6-object-assign`](https://socket.dev/npm/package/es6-object-assign) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/es6-object-assign`
...
```sh
pnpm install @socketregistry/es6-object-assign
```
