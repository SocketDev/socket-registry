...
>A tested zero dependency drop-in replacement of [`for-each`](https://socket.dev/npm/package/for-each) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/for-each`
...
```sh
pnpm install @socketregistry/for-each
```
