...
>A tested zero dependency drop-in replacement of [`function-bind`](https://socket.dev/npm/package/function-bind) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/function-bind`
...
```sh
pnpm install @socketregistry/function-bind
```
