...
>A tested zero dependency drop-in replacement of [`function.prototype.name`](https://socket.dev/npm/package/function.prototype.name) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/function.prototype.name
```
