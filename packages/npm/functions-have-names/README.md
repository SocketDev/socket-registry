...
>A tested zero dependency drop-in replacement of [`functions-have-names`](https://socket.dev/npm/package/functions-have-names) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/functions-have-names
```
