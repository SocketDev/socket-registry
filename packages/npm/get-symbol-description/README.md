...
>A tested zero dependency drop-in replacement of [`get-symbol-description`](https://socket.dev/npm/package/get-symbol-description) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/get-symbol-description`
...
```sh
pnpm install @socketregistry/get-symbol-description
```
