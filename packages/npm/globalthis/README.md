...
>A tested zero dependency drop-in replacement of [`globalthis`](https://socket.dev/npm/package/globalthis) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/globalthis`
...
```sh
pnpm install @socketregistry/globalthis
```
