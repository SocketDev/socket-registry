...
>A tested zero dependency drop-in replacement of [`harmony-reflect`](https://socket.dev/npm/package/harmony-reflect) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/harmony-reflect`
...
```sh
pnpm install @socketregistry/harmony-reflect
```
