...
>A tested zero dependency drop-in replacement of [`has-property-descriptors`](https://socket.dev/npm/package/has-property-descriptors) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/has-property-descriptors`
...
```sh
pnpm install @socketregistry/has-property-descriptors
```
