...
>A tested zero dependency drop-in replacement of [`has-proto`](https://socket.dev/npm/package/has-proto) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/has-proto`
...
```sh
pnpm install @socketregistry/has-proto
```
