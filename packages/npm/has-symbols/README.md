...
>A tested zero dependency drop-in replacement of [`has-symbols`](https://socket.dev/npm/package/has-symbols) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/has-symbols`
...
```sh
pnpm install @socketregistry/has-symbols
```
