...
>A tested zero dependency drop-in replacement of [`has-tostringtag`](https://socket.dev/npm/package/has-tostringtag) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/has-tostringtag`
...
```sh
pnpm install @socketregistry/has-tostringtag
```
