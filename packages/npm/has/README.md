...
>A tested zero dependency drop-in replacement of [`has`](https://socket.dev/npm/package/has) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/has`
...
```sh
pnpm install @socketregistry/has
```
