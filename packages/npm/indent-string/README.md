...
>A tested zero dependency  CJS/ESM compatible drop-in replacement of [`indent-string`](https://socket.dev/npm/package/indent-string) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/indent-string
```
