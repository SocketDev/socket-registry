...
>A tested zero dependency drop-in replacement of [`internal-slot`](https://socket.dev/npm/package/internal-slot) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/internal-slot`
...
```sh
pnpm install @socketregistry/internal-slot
```
