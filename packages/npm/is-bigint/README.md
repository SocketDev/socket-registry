...
>A tested zero dependency drop-in replacement of [`is-bigint`](https://socket.dev/npm/package/is-bigint) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-bigint`
...
```sh
pnpm install @socketregistry/is-bigint
```
