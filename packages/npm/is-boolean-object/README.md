...
>A tested zero dependency drop-in replacement of [`is-boolean-object`](https://socket.dev/npm/package/is-boolean-object) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-boolean-object`
...
```sh
pnpm install @socketregistry/is-boolean-object
```
