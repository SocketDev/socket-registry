...
>A tested zero dependency drop-in replacement of [`is-generator-function`](https://socket.dev/npm/package/is-generator-function) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-generator-function`
...
```sh
pnpm install @socketregistry/is-generator-function
```
