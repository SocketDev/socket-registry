...
>A tested zero dependency  CJS/ESM compatible drop-in replacement of [`is-interactive`](https://socket.dev/npm/package/is-interactive) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-interactive`
...
```sh
pnpm install @socketregistry/is-interactive
```
