...
>A tested zero dependency drop-in replacement of [`is-map`](https://socket.dev/npm/package/is-map) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-map`
...
```sh
pnpm install @socketregistry/is-map
```
