...
>A tested zero dependency drop-in replacement of [`is-nan`](https://socket.dev/npm/package/is-nan) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-nan`
...
```sh
pnpm install @socketregistry/is-nan
```
