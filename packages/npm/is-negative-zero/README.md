...
>A tested zero dependency drop-in replacement of [`is-negative-zero`](https://socket.dev/npm/package/is-negative-zero) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-negative-zero`
...
```sh
pnpm install @socketregistry/is-negative-zero
```
