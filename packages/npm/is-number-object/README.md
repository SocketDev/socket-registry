...
>A tested zero dependency drop-in replacement of [`is-number-object`](https://socket.dev/npm/package/is-number-object) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-number-object`
...
```sh
pnpm install @socketregistry/is-number-object
```
