...
>A tested zero dependency drop-in replacement of [`is-regex`](https://socket.dev/npm/package/is-regex) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/is-regex
```
