...
>A tested zero dependency drop-in replacement of [`is-string`](https://socket.dev/npm/package/is-string) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-string`
...
```sh
pnpm install @socketregistry/is-string
```
