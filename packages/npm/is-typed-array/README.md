...
>A tested zero dependency drop-in replacement of [`is-typed-array`](https://socket.dev/npm/package/is-typed-array) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-typed-array`
...
```sh
pnpm install @socketregistry/is-typed-array
```
