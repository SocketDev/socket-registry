...
>A tested zero dependency  CJS/ESM compatible drop-in replacement of [`is-unicode-supported`](https://socket.dev/npm/package/is-unicode-supported) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/is-unicode-supported`
...
```sh
pnpm install @socketregistry/is-unicode-supported
```
