...
>A tested zero dependency drop-in replacement of [`is-weakset`](https://socket.dev/npm/package/is-weakset) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/is-weakset
```
