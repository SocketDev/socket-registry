...
>A tested zero dependency drop-in replacement of [`isarray`](https://socket.dev/npm/package/isarray) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/isarray`
...
```sh
pnpm install @socketregistry/isarray
```
