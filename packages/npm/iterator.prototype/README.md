...
>A tested zero dependency drop-in replacement of [`iterator.prototype`](https://socket.dev/npm/package/iterator.prototype) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/iterator.prototype`
...
```sh
pnpm install @socketregistry/iterator.prototype
```
