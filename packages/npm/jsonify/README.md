...
>A tested zero dependency drop-in replacement of [`jsonify`](https://socket.dev/npm/package/jsonify) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/jsonify`
...
```sh
pnpm install @socketregistry/jsonify
```
