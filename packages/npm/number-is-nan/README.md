...
>A tested zero dependency drop-in replacement of [`number-is-nan`](https://socket.dev/npm/package/number-is-nan) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/number-is-nan`
...
```sh
pnpm install @socketregistry/number-is-nan
```
