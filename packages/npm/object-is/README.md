...
>A tested zero dependency drop-in replacement of [`object-is`](https://socket.dev/npm/package/object-is) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/object-is`
...
```sh
pnpm install @socketregistry/object-is
```
