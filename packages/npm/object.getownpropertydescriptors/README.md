...
>A tested zero dependency drop-in replacement of [`object.getownpropertydescriptors`](https://socket.dev/npm/package/object.getownpropertydescriptors) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/object.getownpropertydescriptors
```
