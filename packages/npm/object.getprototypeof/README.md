...
>A tested zero dependency drop-in replacement of [`object.getprototypeof`](https://socket.dev/npm/package/object.getprototypeof) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/object.getprototypeof
```
