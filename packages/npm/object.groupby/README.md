...
>A tested zero dependency drop-in replacement of [`object.groupby`](https://socket.dev/npm/package/object.groupby) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/object.groupby`
...
```sh
pnpm install @socketregistry/object.groupby
```
