...
>A tested zero dependency drop-in replacement of [`object.values`](https://socket.dev/npm/package/object.values) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/object.values`
...
```sh
pnpm install @socketregistry/object.values
```
