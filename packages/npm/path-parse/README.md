...
>A tested zero dependency drop-in replacement of [`path-parse`](https://socket.dev/npm/package/path-parse) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/path-parse
```
