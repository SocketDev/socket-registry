...
>A tested zero dependency drop-in replacement of [`promise.any`](https://socket.dev/npm/package/promise.any) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/promise.any`
...
```sh
pnpm install @socketregistry/promise.any
```
