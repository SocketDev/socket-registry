...
>A tested zero dependency drop-in replacement of [`querystringify`](https://socket.dev/npm/package/querystringify) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/querystringify`
...
```sh
pnpm install @socketregistry/querystringify
```
