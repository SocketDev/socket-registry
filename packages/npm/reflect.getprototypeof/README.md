...
>A tested zero dependency drop-in replacement of [`reflect.getprototypeof`](https://socket.dev/npm/package/reflect.getprototypeof) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/reflect.getprototypeof`
...
```sh
pnpm install @socketregistry/reflect.getprototypeof
```
