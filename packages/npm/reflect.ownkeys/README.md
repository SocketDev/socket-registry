...
>A tested zero dependency drop-in replacement of [`reflect.ownkeys`](https://socket.dev/npm/package/reflect.ownkeys) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/reflect.ownkeys`
...
```sh
pnpm install @socketregistry/reflect.ownkeys
```
