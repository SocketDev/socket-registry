...
>A tested zero dependency drop-in replacement of [`regexp.prototype.flags`](https://socket.dev/npm/package/regexp.prototype.flags) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/regexp.prototype.flags`
...
```sh
pnpm install @socketregistry/regexp.prototype.flags
```
