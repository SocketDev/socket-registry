...
>A tested zero dependency drop-in replacement of [`safe-array-concat`](https://socket.dev/npm/package/safe-array-concat) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/safe-array-concat
```
