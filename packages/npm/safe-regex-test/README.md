...
>A tested zero dependency drop-in replacement of [`safe-regex-test`](https://socket.dev/npm/package/safe-regex-test) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/safe-regex-test`
...
```sh
pnpm install @socketregistry/safe-regex-test
```
