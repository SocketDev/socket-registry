...
>A tested zero dependency drop-in replacement of [`safer-buffer`](https://socket.dev/npm/package/safer-buffer) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/safer-buffer`
...
```sh
pnpm install @socketregistry/safer-buffer
```
