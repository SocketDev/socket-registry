...
>A tested zero dependency drop-in replacement of [`side-channel`](https://socket.dev/npm/package/side-channel) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/side-channel`
...
```sh
pnpm install @socketregistry/side-channel
```
