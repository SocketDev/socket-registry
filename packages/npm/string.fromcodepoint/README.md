...
>A tested zero dependency drop-in replacement of [`string.fromcodepoint`](https://socket.dev/npm/package/string.fromcodepoint) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.fromcodepoint`
...
```sh
pnpm install @socketregistry/string.fromcodepoint
```
