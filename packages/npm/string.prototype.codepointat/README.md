...
>A tested zero dependency drop-in replacement of [`string.prototype.codepointat`](https://socket.dev/npm/package/string.prototype.codepointat) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.codepointat`
...
```sh
pnpm install @socketregistry/string.prototype.codepointat
```
