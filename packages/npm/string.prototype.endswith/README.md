...
>A tested zero dependency drop-in replacement of [`string.prototype.endswith`](https://socket.dev/npm/package/string.prototype.endswith) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.endswith`
...
```sh
pnpm install @socketregistry/string.prototype.endswith
```
