...
>A tested zero dependency drop-in replacement of [`string.prototype.matchall`](https://socket.dev/npm/package/string.prototype.matchall) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.matchall`
...
```sh
pnpm install @socketregistry/string.prototype.matchall
```
