...
>A tested zero dependency drop-in replacement of [`string.prototype.padend`](https://socket.dev/npm/package/string.prototype.padend) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.padend`
...
```sh
pnpm install @socketregistry/string.prototype.padend
```
