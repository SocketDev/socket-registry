...
>A tested zero dependency drop-in replacement of [`string.prototype.padstart`](https://socket.dev/npm/package/string.prototype.padstart) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.padstart`
...
```sh
pnpm install @socketregistry/string.prototype.padstart
```
