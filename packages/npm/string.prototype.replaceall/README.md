...
>A tested zero dependency drop-in replacement of [`string.prototype.replaceall`](https://socket.dev/npm/package/string.prototype.replaceall) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.replaceall`
...
```sh
pnpm install @socketregistry/string.prototype.replaceall
```
