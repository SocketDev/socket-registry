...
>A tested zero dependency drop-in replacement of [`string.prototype.trimend`](https://socket.dev/npm/package/string.prototype.trimend) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.trimend`
...
```sh
pnpm install @socketregistry/string.prototype.trimend
```
