...
>A tested zero dependency drop-in replacement of [`string.prototype.trimright`](https://socket.dev/npm/package/string.prototype.trimright) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.trimright`
...
```sh
pnpm install @socketregistry/string.prototype.trimright
```
