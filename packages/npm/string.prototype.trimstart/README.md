...
>A tested zero dependency drop-in replacement of [`string.prototype.trimstart`](https://socket.dev/npm/package/string.prototype.trimstart) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/string.prototype.trimstart`
...
```sh
pnpm install @socketregistry/string.prototype.trimstart
```
