...
>A tested zero dependency drop-in replacement of [`typed-array-buffer`](https://socket.dev/npm/package/typed-array-buffer) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/typed-array-buffer`
...
```sh
pnpm install @socketregistry/typed-array-buffer
```
