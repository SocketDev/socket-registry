...
>A tested zero dependency drop-in replacement of [`typed-array-byte-offset`](https://socket.dev/npm/package/typed-array-byte-offset) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/typed-array-byte-offset`
...
```sh
pnpm install @socketregistry/typed-array-byte-offset
```
