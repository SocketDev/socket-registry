...
>A tested zero dependency drop-in replacement of [`unbox-primitive`](https://socket.dev/npm/package/unbox-primitive) complete with TypeScript types.
...
Prefer to do it yourself? Add `@socketregistry/unbox-primitive`
...
```sh
pnpm install @socketregistry/unbox-primitive
```
