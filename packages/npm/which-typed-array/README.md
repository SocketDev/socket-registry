...
>A tested zero dependency drop-in replacement of [`which-typed-array`](https://socket.dev/npm/package/which-typed-array) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/which-typed-array
```
