...
>A tested zero dependency  CJS/ESM compatible drop-in replacement of [`yocto-spinner`](https://socket.dev/npm/package/yocto-spinner) complete with TypeScript types.
...
```sh
pnpm install @socketregistry/yocto-spinner
```
