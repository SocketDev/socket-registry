...
- Regenerated `manifest.json` after the root @socketregistry/packageurl-js 1.4.7 bump.
- Refreshed workspace dependency pins: @socketsecurity/sdk 4.0.3.
...
- Updated @socketregistry/packageurl-js to 1.3.5
- Upgraded @socketsecurity/lib to v3.1.3

## [2.0.1] - 2025-11-01

### Changed

- Upgraded @socketsecurity/lib to v3.0.3

### Fixed

- Added yoctocolors-cjs dependency for build script
