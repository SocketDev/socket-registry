...
export async function getIpc<K extends keyof IpcObject>(key: K): Promise<IpcObject[K]>
export async function getIpc(key?: keyof IpcObject): Promise<IpcObject | IpcObject[keyof IpcObject]> {
