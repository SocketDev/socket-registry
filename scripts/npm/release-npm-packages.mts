...
function getCachedAbortSignal(): AbortSignal {
...
let cachedDefaultSpinner: ReturnType<typeof getDefaultSpinner> | undefined
function getCachedDefaultSpinner(): ReturnType<typeof getDefaultSpinner> {
  if (cachedDefaultSpinner === undefined) {
    cachedDefaultSpinner = getDefaultSpinner()
  }
  return cachedDefaultSpinner
}
