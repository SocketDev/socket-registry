 ...
 *   external tools from the repository registry.
 *   Usage: `pnpm run` setup # Check prerequisites, install tools `pnpm run`
 *   setup --quiet # Minimal output (for postinstall)
 */
...
async function main(): Promise<void> {
  ...
  const configPath = EXTERNAL_TOOLS_CONFIG_PATH
