...
describe('fetchPackageProvenance', () => {
  ...
  it('should return undefined for network errors', async () => {
    ...
    const result = await fetchPackageProvenance('', '1.0.0')
  ...
  it('should handle package names with maximum lengths', async () => {
    ...
    const result = await fetchPackageProvenance(longPackageName, '1.0.0')
  ...
  it('should handle concurrent requests properly', async () => {
    ...
    const promises = [
      fetchPackageProvenance('test-package-1', '1.0.0'),
      fetchPackageProvenance('test-package-2', '2.0.0'),
      fetchPackageProvenance('test-package-3', '3.0.0'),
    ]
  ...
  it('should properly encode package names with slashes and at symbols', async () => {
    ...
    const result = await fetchPackageProvenance('@scope/package-name', '1.0.0')
  ...
  it('should maintain consistent behavior across multiple calls', async () => {
    ...
    const results = await Promise.all([
      fetchPackageProvenance(packageName, version),
      fetchPackageProvenance(packageName, version),
      fetchPackageProvenance(packageName, version),
    ])
