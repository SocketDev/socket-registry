// vitest specs for scripts/fleet/check/lock-step-headers-match.mts.
//
// The header gate is the §7 companion to §5–6 path-refs gate. Where
// lock-step-refs-resolve.mts validates that named paths resolve, this
